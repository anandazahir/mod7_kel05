...
public class Tracker extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            double average = 0;
            int count = 0;
            List<Double> evenNumbers = trackerBean.getEvenNumbers();
            List<Double> oddNumbers = trackerBean.getOddNumbers();
            ...
            out.println("Bilangan Genap: " + evenNumbers + "<br />");
            out.println("Bilangan Ganjil: " + oddNumbers + "<br />");
